...
' Create the shortcut
Set oShortcut = wshShell.CreateShortcut(strDesktop & "\ILO RAD Suite.lnk")
...
MsgBox "Desktop shortcut 'ILO RAD Suite' created successfully!" & vbCrLf & vbCrLf & "You can now launch the software directly from your Desktop.", 64, "Shortcut Created"
