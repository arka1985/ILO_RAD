@echo off
echo ===================================================
echo DICOM Push Utility - Automated Web Installer
echo ===================================================
echo.
...
echo sLinkFile = "%USERPROFILE%\Desktop\DICOM Push Utility.lnk" >> %SCRIPT%
echo Set oLink = oWS.CreateShortcut(sLinkFile) >> %SCRIPT%
echo oLink.TargetPath = "%~dp0start.vbs" >> %SCRIPT%
echo oLink.WorkingDirectory = "%~dp0" >> %SCRIPT%
echo oLink.IconLocation = "imageres.dll, 227" >> %SCRIPT%
...
echo Double-click "DICOM Push Utility" to start the app.
echo ===================================================
pause
