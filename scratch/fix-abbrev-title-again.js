...
for (const dir of dirs) {
  ...
  if (fs.existsSync(abbrevPath)) {
    ...
    const oldTitleBlock = `<div className="text-center mb-4 border-b-2 border-black pb-2">
    ...
    const newTitleBlock = `<div className="text-center font-bold text-lg mb-4 text-black border-b-2 border-black pb-2">
